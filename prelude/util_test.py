    ...
    class FunctionMonad(_coconut.collections.namedtuple("FunctionMonad", "func")):
        ...
        def __call__(*_coconut_match_to_args, **_coconut_match_to_kwargs):
            ...
            if not _coconut_match_check:
                _coconut_match_err = _coconut_FunctionMatchError("pattern-matching failed for " "'def __call__(FunctionMonad(func), *args, **kwargs) ='" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
