...
def test_definesBind():  #13 (line in coconut source)
    ...
    class FunctionMonad(_coconut.collections.namedtuple("FunctionMonad", ('func',))):  #14 (line in coconut source)
        ...
        def __call__(*_coconut_match_args, **_coconut_match_kwargs):  #23 (line in coconut source)
            ...
            if (_coconut.len(_coconut_match_args) >= 1) and (_coconut.isinstance(_coconut_match_args[0], FunctionMonad)) and (_coconut.len(_coconut_match_args[0]) == 1):  #23 (line in coconut source)
                func = _coconut_match_args[0][0]  #23 (line in coconut source)
                args = _coconut_match_args[1:]  #23 (line in coconut source)
                kwargs = _coconut_match_kwargs  #23 (line in coconut source)
