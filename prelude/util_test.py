            ...
            if _coconut_match_check_0:  #23 (line num in coconut source)
                ...
                if not _coconut_match_check_0:  #23 (line num in coconut source)
                    ...
                    if _coconut_match_check_0:  #23 (line num in coconut source)
                        ...
                        if not _coconut_match_check_0:  #23 (line num in coconut source)
                            _coconut_match_set_name_func = _coconut_sentinel  #23 (line num in coconut source)
                            if _coconut.type(_coconut_match_args[0]) in _coconut_self_match_types:  #23 (line num in coconut source)
                        ...
                        if not _coconut_match_check_0:  #23 (line num in coconut source)
                            _coconut_match_set_name_func = _coconut_sentinel  #23 (line num in coconut source)
                            if not _coconut.type(_coconut_match_args[0]) in _coconut_self_match_types:  #23 (line num in coconut source)
