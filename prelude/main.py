...
head = _coconut.functools.partial(_coconut_igetitem, index=(0))  #854 (line num in coconut source)

last: '_coconut.typing.Callable[[_coconut.typing.Iterable[Ta]], Ta]'  #856 (line num in coconut source)
last = _coconut.functools.partial(_coconut_igetitem, index=(-1))  #857 (line num in coconut source)

tail: '_coconut.typing.Callable[[_coconut.typing.Iterable[Ta]], _coconut.typing.Iterable[Ta]]'  #859 (line num in coconut source)
tail = _coconut.functools.partial(_coconut_igetitem, index=(_coconut.slice(1, None)))  # type: ignore  #860 (line num in coconut source)

init: '_coconut.typing.Callable[[_coconut.typing.Iterable[Ta]], _coconut.typing.Iterable[Ta]]'  #862 (line num in coconut source)
init = _coconut.functools.partial(_coconut_igetitem, index=(_coconut.slice(None, -1)))  # type: ignore  #863 (line num in coconut source)
...
def at(xs: '_coconut.typing.Iterable[Ta]', i: 'int') -> 'Ta':  #865 (line num in coconut source)
    ...
    return _coconut_tail_call(_coconut_igetitem, xs, i)  #870 (line num in coconut source)
...
def scanr(func: '_coconut.typing.Callable[[Ta, Tb], Ta]', init: 'Ta', xs: '_coconut.typing.Sequence[Tb]') -> '_coconut.typing.Iterable[Ta]':  #907 (line num in coconut source)
    return _coconut_tail_call(_coconut_igetitem, scan(func, reversed(xs), init), _coconut.slice(None, None, -1))  #908 (line num in coconut source)
...
def scanr1(func: '_coconut.typing.Callable[[Ta, Ta], Ta]', xs: '_coconut.typing.Sequence[Ta]') -> '_coconut.typing.Iterable[Ta]':  #910 (line num in coconut source)
    return _coconut_tail_call(_coconut_igetitem, scan(func, reversed(xs)), _coconut.slice(None, None, -1))  #911 (line num in coconut source)
...
def replicate(n: 'int', x: 'Ta') -> '_coconut.typing.Iterable[Ta]':  #922 (line num in coconut source)
    return _coconut_tail_call(_coconut_igetitem, repeat(x), _coconut.slice(None, n))  #923 (line num in coconut source)
...
def take(n: 'int', xs: '_coconut.typing.Iterable[Ta]') -> '_coconut.typing.Iterable[Ta]':  #936 (line num in coconut source)
    return _coconut_tail_call(_coconut_igetitem, xs, _coconut.slice(None, n))  #937 (line num in coconut source)
...
def drop(n: 'int', xs: '_coconut.typing.Iterable[Ta]') -> '_coconut.typing.Iterable[Ta]':  #939 (line num in coconut source)
    return _coconut_tail_call(_coconut_igetitem, xs, _coconut.slice(n, None))  #940 (line num in coconut source)
...
def splitAt(n: 'int', xs: '_coconut.typing.Iterable[Ta]') -> 'T.Tuple[_coconut.typing.Iterable[Ta], _coconut.typing.Iterable[Ta]]':  #942 (line num in coconut source)
    ...
    return (_coconut_igetitem(reit, _coconut.slice(None, n)), _coconut_igetitem(reit, _coconut.slice(n, None)))  #944 (line num in coconut source)
...
def lookup(key: 'Ta', assocs: '_coconut.typing.Iterable[T.Tuple[Ta, Tb]]') -> 'Maybe':  #975 (line num in coconut source)
    try:  #976 (line num in coconut source)
        return (((Just)((_coconut_igetitem((dropwhile)(lambda pair: pair[0] != key, assocs), (0)))[1])))  #977 (line num in coconut source)
