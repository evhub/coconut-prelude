...
if TYPE_CHECKING:  #64 (line in coconut source)
    ...
    def maybe(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #68 (line in coconut source)
        _coconut_match_check = False  #68 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #68 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 3) and ("default" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[2], Nothing)) and (_coconut.len(_coconut_match_to_args[2]) == 0):  #68 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("default")  #68 (line in coconut source)
            if not _coconut_match_to_kwargs:  #68 (line in coconut source)
                default = _coconut_match_temp_0  #68 (line in coconut source)
                _coconut_match_check = True  #68 (line in coconut source)
        if not _coconut_match_check:  #68 (line in coconut source)
            raise _coconut_FunctionMatchError('match def maybe(default, _, Nothing()) = default', _coconut_match_to_args)  #68 (line in coconut source)
    ...
    def maybe(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #69 (line in coconut source)
        _coconut_match_check = False  #69 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #69 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 3) and ("func" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[2], Just)) and (_coconut.len(_coconut_match_to_args[2]) == 1):  #69 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("func")  #69 (line in coconut source)
            x = _coconut_match_to_args[2][0]  #69 (line in coconut source)
            if not _coconut_match_to_kwargs:  #69 (line in coconut source)
                func = _coconut_match_temp_0  #69 (line in coconut source)
                _coconut_match_check = True  #69 (line in coconut source)
        if not _coconut_match_check:  #69 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def maybe(_, func, Just(x)) = func x', _coconut_match_to_args)  #69 (line in coconut source)
...
if TYPE_CHECKING:  #89 (line in coconut source)
    ...
    def either(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #93 (line in coconut source)
        _coconut_match_check = False  #93 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #93 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 3) and ("left_func" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[2], Left)) and (_coconut.len(_coconut_match_to_args[2]) == 1):  #93 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("left_func")  #93 (line in coconut source)
            x = _coconut_match_to_args[2][0]  #93 (line in coconut source)
            if not _coconut_match_to_kwargs:  #93 (line in coconut source)
                left_func = _coconut_match_temp_0  #93 (line in coconut source)
                _coconut_match_check = True  #93 (line in coconut source)
        if not _coconut_match_check:  #93 (line in coconut source)
            raise _coconut_FunctionMatchError('match def either(left_func, _, Left(x)) = left_func x', _coconut_match_to_args)  #93 (line in coconut source)
    ...
    def either(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #94 (line in coconut source)
        _coconut_match_check = False  #94 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #94 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 3) and ("right_func" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[2], Right)) and (_coconut.len(_coconut_match_to_args[2]) == 1):  #94 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("right_func")  #94 (line in coconut source)
            x = _coconut_match_to_args[2][0]  #94 (line in coconut source)
            if not _coconut_match_to_kwargs:  #94 (line in coconut source)
                right_func = _coconut_match_temp_0  #94 (line in coconut source)
                _coconut_match_check = True  #94 (line in coconut source)
        if not _coconut_match_check:  #94 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def either(_, right_func, Right(x)) = right_func x', _coconut_match_to_args)  #94 (line in coconut source)
...
if TYPE_CHECKING:  #155 (line in coconut source)
    ...
    def compare(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #159 (line in coconut source)
        _coconut_match_check = False  #159 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #159 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "x" in _coconut_match_to_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "y" in _coconut_match_to_kwargs)) == 1):  #159 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("x")  #159 (line in coconut source)
            _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("y")  #159 (line in coconut source)
            if not _coconut_match_to_kwargs:  #159 (line in coconut source)
                x = _coconut_match_temp_0  #159 (line in coconut source)
                y = _coconut_match_temp_1  #159 (line in coconut source)
                _coconut_match_check = True  #159 (line in coconut source)
        if _coconut_match_check and not (x == y):  #159 (line in coconut source)
            _coconut_match_check = False  #159 (line in coconut source)
        if not _coconut_match_check:  #159 (line in coconut source)
            raise _coconut_FunctionMatchError('match def compare(x, y if x == y) = eq', _coconut_match_to_args)  #159 (line in coconut source)
    ...
    def compare(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #160 (line in coconut source)
        _coconut_match_check = False  #160 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #160 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "x" in _coconut_match_to_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "y" in _coconut_match_to_kwargs)) == 1):  #160 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("x")  #160 (line in coconut source)
            _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("y")  #160 (line in coconut source)
            if not _coconut_match_to_kwargs:  #160 (line in coconut source)
                x = _coconut_match_temp_0  #160 (line in coconut source)
                y = _coconut_match_temp_1  #160 (line in coconut source)
                _coconut_match_check = True  #160 (line in coconut source)
        if _coconut_match_check and not (x < y):  #160 (line in coconut source)
            _coconut_match_check = False  #160 (line in coconut source)
        if not _coconut_match_check:  #160 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def compare(x, y if x < y) = lt', _coconut_match_to_args)  #160 (line in coconut source)
    ...
    def compare(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #161 (line in coconut source)
        _coconut_match_check = False  #161 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #161 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "x" in _coconut_match_to_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "y" in _coconut_match_to_kwargs)) == 1):  #161 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("x")  #161 (line in coconut source)
            _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("y")  #161 (line in coconut source)
            if not _coconut_match_to_kwargs:  #161 (line in coconut source)
                x = _coconut_match_temp_0  #161 (line in coconut source)
                y = _coconut_match_temp_1  #161 (line in coconut source)
                _coconut_match_check = True  #161 (line in coconut source)
        if _coconut_match_check and not (x > y):  #161 (line in coconut source)
            _coconut_match_check = False  #161 (line in coconut source)
        if not _coconut_match_check:  #161 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def compare(x, y if x > y) = gt', _coconut_match_to_args)  #161 (line in coconut source)
...
if TYPE_CHECKING:  #286 (line in coconut source)
    ...
    def signum(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #290 (line in coconut source)
        _coconut_match_check = False  #290 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #290 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut_match_to_args[0] == 0):  #290 (line in coconut source)
            if not _coconut_match_to_kwargs:  #290 (line in coconut source)
                _coconut_match_check = True  #290 (line in coconut source)
        if not _coconut_match_check:  #290 (line in coconut source)
            raise _coconut_FunctionMatchError('match def signum(0) = 0', _coconut_match_to_args)  #290 (line in coconut source)
    ...
    def signum(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #291 (line in coconut source)
        _coconut_match_check = False  #291 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #291 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "x" in _coconut_match_to_kwargs)) == 1):  #291 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("x")  #291 (line in coconut source)
            if not _coconut_match_to_kwargs:  #291 (line in coconut source)
                x = _coconut_match_temp_0  #291 (line in coconut source)
                _coconut_match_check = True  #291 (line in coconut source)
        if _coconut_match_check and not (x > 0):  #291 (line in coconut source)
            _coconut_match_check = False  #291 (line in coconut source)
        if not _coconut_match_check:  #291 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def signum(x if x > 0) = 1', _coconut_match_to_args)  #291 (line in coconut source)
    ...
    def signum(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #292 (line in coconut source)
        _coconut_match_check = False  #292 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #292 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "x" in _coconut_match_to_kwargs)) == 1):  #292 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("x")  #292 (line in coconut source)
            if not _coconut_match_to_kwargs:  #292 (line in coconut source)
                x = _coconut_match_temp_0  #292 (line in coconut source)
                _coconut_match_check = True  #292 (line in coconut source)
        if _coconut_match_check and not (x < 0):  #292 (line in coconut source)
            _coconut_match_check = False  #292 (line in coconut source)
        if not _coconut_match_check:  #292 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def signum(x if x < 0) = -1', _coconut_match_to_args)  #292 (line in coconut source)
...
if TYPE_CHECKING:  #299 (line in coconut source)
    ...
    def toRational(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #303 (line in coconut source)
        _coconut_match_check = False  #303 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #303 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "real" in _coconut_match_to_kwargs)) == 1):  #303 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("real")  #303 (line in coconut source)
            if (_coconut.isinstance(_coconut_match_temp_0, float)) and (not _coconut_match_to_kwargs):  #303 (line in coconut source)
                real = _coconut_match_temp_0  #303 (line in coconut source)
                _coconut_match_check = True  #303 (line in coconut source)
        if not _coconut_match_check:  #303 (line in coconut source)
            raise _coconut_FunctionMatchError('match def toRational(real is float) =', _coconut_match_to_args)  #303 (line in coconut source)
    ...
    def toRational(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #305 (line in coconut source)
        _coconut_match_check = False  #305 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #305 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "real" in _coconut_match_to_kwargs)) == 1):  #305 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("real")  #305 (line in coconut source)
            if not _coconut_match_to_kwargs:  #305 (line in coconut source)
                real = _coconut_match_temp_0  #305 (line in coconut source)
                _coconut_match_check = True  #305 (line in coconut source)
        if not _coconut_match_check:  #305 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def toRational(real) =', _coconut_match_to_args)  #305 (line in coconut source)
...
if TYPE_CHECKING:  #434 (line in coconut source)
    ...
    def lcm(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #438 (line in coconut source)
        _coconut_match_check = False  #438 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #438 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 2) and (_coconut_match_to_args[1] == 0):  #438 (line in coconut source)
            if not _coconut_match_to_kwargs:  #438 (line in coconut source)
                _coconut_match_check = True  #438 (line in coconut source)
        if not _coconut_match_check:  #438 (line in coconut source)
            raise _coconut_FunctionMatchError('match def lcm(_, 0) = 0', _coconut_match_to_args)  #438 (line in coconut source)
    ...
    def lcm(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #439 (line in coconut source)
        _coconut_match_check = False  #439 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #439 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 2) and (_coconut_match_to_args[0] == 0):  #439 (line in coconut source)
            if not _coconut_match_to_kwargs:  #439 (line in coconut source)
                _coconut_match_check = True  #439 (line in coconut source)
        if not _coconut_match_check:  #439 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def lcm(0, _) = 0', _coconut_match_to_args)  #439 (line in coconut source)
    ...
    def lcm(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #440 (line in coconut source)
        _coconut_match_check = False  #440 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #440 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "x" in _coconut_match_to_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "y" in _coconut_match_to_kwargs)) == 1):  #440 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("x")  #440 (line in coconut source)
            _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("y")  #440 (line in coconut source)
            if not _coconut_match_to_kwargs:  #440 (line in coconut source)
                x = _coconut_match_temp_0  #440 (line in coconut source)
                y = _coconut_match_temp_1  #440 (line in coconut source)
                _coconut_match_check = True  #440 (line in coconut source)
        if not _coconut_match_check:  #440 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def lcm(x, y) =', _coconut_match_to_args)  #440 (line in coconut source)
...
# Default implementation
    ...
    for m in ms:  #641 (line in coconut source)
        if m:  #642 (line in coconut source)
            vals.extend(m)  #643 (line in coconut source)
        else:  #644 (line in coconut source)
            fallback = m  #645 (line in coconut source)
...
if TYPE_CHECKING:  #650 (line in coconut source)
    ...
    def do(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #654 (line in coconut source)
        _coconut_match_check = False  #654 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #654 (line in coconut source)
        if (1 <= _coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "func" in _coconut_match_to_kwargs)) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 0):  #654 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("func")  #654 (line in coconut source)
            if not _coconut_match_to_kwargs:  #654 (line in coconut source)
                func = _coconut_match_temp_0  #654 (line in coconut source)
                _coconut_match_check = True  #654 (line in coconut source)
        if not _coconut_match_check:  #654 (line in coconut source)
            raise _coconut_FunctionMatchError('match def do([], func) = func()', _coconut_match_to_args)  #654 (line in coconut source)
    ...
    def do(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #655 (line in coconut source)
        """
        The call
            do([m1, m2, ...], func)
        ...
        _coconut_match_check = False  #675 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #675 (line in coconut source)
        if (1 <= _coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "func" in _coconut_match_to_kwargs)) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) >= 1):  #675 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("func")  #675 (line in coconut source)
            ms = _coconut.list(_coconut_match_to_args[0][1:])  #675 (line in coconut source)
            m = _coconut_match_to_args[0][0]  #675 (line in coconut source)
            if not _coconut_match_to_kwargs:  #675 (line in coconut source)
                func = _coconut_match_temp_0  #675 (line in coconut source)
                _coconut_match_check = True  #675 (line in coconut source)
        if not _coconut_match_check:  #675 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def do([m] + ms, func) =', _coconut_match_to_args)  #675 (line in coconut source)
...
def until(cond: '_coconut.typing.Callable[[Ta], bool]', func: '_coconut.typing.Callable[[Ta], Ta]', x: 'Ta') -> 'Ta':  #787 (line in coconut source)
    def _coconut_mock_func(cond: '_coconut.typing.Callable[[Ta], bool]', func: '_coconut.typing.Callable[[Ta], Ta]', x: 'Ta'): return cond, func, x  #788 (line in coconut source)
    while True:  #788 (line in coconut source)
        ...
        try:  # tail recursive  #790 (line in coconut source)
            _coconut_is_recursive = until is _coconut_recursive_func_72  # tail recursive  #790 (line in coconut source)
        except _coconut.NameError:  # tail recursive  #790 (line in coconut source)
            _coconut_is_recursive = False  # tail recursive  #790 (line in coconut source)
        if _coconut_is_recursive:  # tail recursive  #790 (line in coconut source)
            cond, func, x = _coconut_mock_func(cond, func, func(x))  # tail recursive  #790 (line in coconut source)
...
map = _map  #847 (line in coconut source)
...
filter = _filter  #857 (line in coconut source)
...
if TYPE_CHECKING:  #931 (line in coconut source)
    ...
    def cycle(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #935 (line in coconut source)
        _coconut_match_check = False  #935 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #935 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "xs" in _coconut_match_to_kwargs)) == 1):  #935 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("xs")  #935 (line in coconut source)
            if not _coconut_match_to_kwargs:  #935 (line in coconut source)
                xs = _coconut_match_temp_0  #935 (line in coconut source)
                _coconut_match_check = True  #935 (line in coconut source)
        if _coconut_match_check and not (len(xs) > 0):  #935 (line in coconut source)
            _coconut_match_check = False  #935 (line in coconut source)
        if not _coconut_match_check:  #935 (line in coconut source)
            raise _coconut_FunctionMatchError('def cycle(xs if len(xs) > 0) =', _coconut_match_to_args)  #935 (line in coconut source)
...
if TYPE_CHECKING:  #958 (line in coconut source)
    ...
    def span(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #962 (line in coconut source)
        _coconut_match_check = False  #962 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #962 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 2) and (_coconut.isinstance(_coconut_match_to_args[1], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[1]) == 0):  #962 (line in coconut source)
            if not _coconut_match_to_kwargs:  #962 (line in coconut source)
                _coconut_match_check = True  #962 (line in coconut source)
        if not _coconut_match_check:  #962 (line in coconut source)
            raise _coconut_FunctionMatchError('match def span(_, []) = ([], [])', _coconut_match_to_args)  #962 (line in coconut source)
    ...
    def span(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #963 (line in coconut source)
        _coconut_match_check = False  #963 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #963 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 2) and ("cond" not in _coconut_match_to_kwargs) and (_coconut.isinstance(_coconut_match_to_args[1], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[1]) >= 1):  #963 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("cond")  #963 (line in coconut source)
            xs = _coconut.list(_coconut_match_to_args[1][1:])  #963 (line in coconut source)
            x = _coconut_match_to_args[1][0]  #963 (line in coconut source)
            if not _coconut_match_to_kwargs:  #963 (line in coconut source)
                cond = _coconut_match_temp_0  #963 (line in coconut source)
                _coconut_match_check = True  #963 (line in coconut source)
        if _coconut_match_check and not (cond(x)):  #963 (line in coconut source)
            _coconut_match_check = False  #963 (line in coconut source)
        if not _coconut_match_check:  #963 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def span(cond, [x] + xs if cond(x)) =', _coconut_match_to_args)  #963 (line in coconut source)
    ...
    def span(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #966 (line in coconut source)
        _coconut_match_check = False  #966 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #966 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 0, "cond" in _coconut_match_to_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_to_args) > 1, "xs" in _coconut_match_to_kwargs)) == 1):  #966 (line in coconut source)
            _coconut_match_temp_0 = _coconut_match_to_args[0] if _coconut.len(_coconut_match_to_args) > 0 else _coconut_match_to_kwargs.pop("cond")  #966 (line in coconut source)
            _coconut_match_temp_1 = _coconut_match_to_args[1] if _coconut.len(_coconut_match_to_args) > 1 else _coconut_match_to_kwargs.pop("xs")  #966 (line in coconut source)
            if not _coconut_match_to_kwargs:  #966 (line in coconut source)
                cond = _coconut_match_temp_0  #966 (line in coconut source)
                xs = _coconut_match_temp_1  #966 (line in coconut source)
                _coconut_match_check = True  #966 (line in coconut source)
        if not _coconut_match_check:  #966 (line in coconut source)
            raise _coconut_FunctionMatchError('addpattern def span(cond, xs) =', _coconut_match_to_args)  #966 (line in coconut source)
...
zip = _zip  #997 (line in coconut source)
