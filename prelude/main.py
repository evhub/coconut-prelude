...
_cycle = cycle  # type: _coconut.typing.Callable[..., T.Any]  #42 (line in Coconut source)
if "__annotations__" not in _coconut.locals():  #42 (line in Coconut source)
    __annotations__ = {}  #42 (line in Coconut source)
__annotations__["_cycle"] = '_coconut.typing.Callable[..., T.Any]'  #42 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #44 (line in Coconut source)
    __annotations__ = {}  #44 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #56 (line in Coconut source)
    __annotations__ = {}  #56 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #59 (line in Coconut source)
    __annotations__ = {}  #59 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #77 (line in Coconut source)
    __annotations__ = {}  #77 (line in Coconut source)
...
if TYPE_CHECKING:  #83 (line in Coconut source)
    ...
    def maybe(*_coconut_match_args, **_coconut_match_kwargs):  #87 (line in Coconut source)
        ...
        if _coconut_match_check_0:  #87 (line in Coconut source)
            ...
            if not _coconut_match_check_0:  #87 (line in Coconut source)
                if (_coconut_match_temp_1) and (_coconut.isinstance(_coconut_match_args[2], Nothing)) and (_coconut.len(_coconut_match_args[2]) == 0):  #87 (line in Coconut source)
                    _coconut_match_check_0 = True  #87 (line in Coconut source)
                ...
                if _coconut_match_check_0:  #87 (line in Coconut source)
                    ...
                    if not _coconut_match_check_0:  #87 (line in Coconut source)
                        if not _coconut.type(_coconut_match_args[2]) in _coconut_self_match_types:  #87 (line in Coconut source)
                            _coconut_match_temp_2 = _coconut.getattr(Nothing, '__match_args__', ())  #87 (line in Coconut source)
                            ...
                            if _coconut.len(_coconut_match_temp_2) < 0:  #87 (line in Coconut source)
                                raise _coconut.TypeError("too many positional args in class match (pattern requires 0; 'Nothing' only supports %s)" % (_coconut.len(_coconut_match_temp_2),))  #87 (line in Coconut source)
                            _coconut_match_check_0 = True  #87 (line in Coconut source)
    ...
    @_coconut_addpattern(maybe)  #88 (line in Coconut source)
    @_coconut_tco  #88 (line in Coconut source)
    @_coconut_mark_as_match  #88 (line in Coconut source)
    def maybe(*_coconut_match_args, **_coconut_match_kwargs):  #88 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) == 3) and ("func" not in _coconut_match_kwargs):  #88 (line in Coconut source)
            _coconut_match_temp_3 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("func")  #88 (line in Coconut source)
            _coconut_match_temp_4 = _coconut.getattr(Just, "_coconut_is_data", False) or _coconut.isinstance(Just, _coconut.tuple) and _coconut.all(_coconut.getattr(_coconut_x, "_coconut_is_data", False) for _coconut_x in Just)  # type: ignore  #88 (line in Coconut source)
            _coconut_match_set_name_func = _coconut_match_temp_3  #88 (line in Coconut source)
        ...
        if _coconut_match_check_1:  #88 (line in Coconut source)
            ...
            if not _coconut_match_check_1:  #88 (line in Coconut source)
                ...
                if (_coconut_match_temp_4) and (_coconut.isinstance(_coconut_match_args[2], Just)) and (_coconut.len(_coconut_match_args[2]) == 1):  #88 (line in Coconut source)
            ...
            if not _coconut_match_check_1:  #88 (line in Coconut source)
                if (not _coconut_match_temp_4) and (_coconut.isinstance(_coconut_match_args[2], Just)):  #88 (line in Coconut source)
                    _coconut_match_check_1 = True  #88 (line in Coconut source)
                if _coconut_match_check_1:  #88 (line in Coconut source)
                    _coconut_match_check_1 = False  #88 (line in Coconut source)
                    if not _coconut_match_check_1:  #88 (line in Coconut source)
                    ...
                    if not _coconut_match_check_1:  #88 (line in Coconut source)
                        ...
                        if not _coconut.type(_coconut_match_args[2]) in _coconut_self_match_types:  #88 (line in Coconut source)
                            _coconut_match_temp_5 = _coconut.getattr(Just, '__match_args__', ())  #88 (line in Coconut source)
                            if not _coconut.isinstance(_coconut_match_temp_5, _coconut.tuple):  #88 (line in Coconut source)
                                raise _coconut.TypeError("Just.__match_args__ must be a tuple")  #88 (line in Coconut source)
                            if _coconut.len(_coconut_match_temp_5) < 1:  #88 (line in Coconut source)
                                raise _coconut.TypeError("too many positional args in class match (pattern requires 1; 'Just' only supports %s)" % (_coconut.len(_coconut_match_temp_5),))  #88 (line in Coconut source)
                            _coconut_match_temp_6 = _coconut.getattr(_coconut_match_args[2], _coconut_match_temp_5[0], _coconut_sentinel)  #88 (line in Coconut source)
                            if _coconut_match_temp_6 is not _coconut_sentinel:  #88 (line in Coconut source)
                                _coconut_match_set_name_x = _coconut_match_temp_6  #88 (line in Coconut source)
                                _coconut_match_check_1 = True  #88 (line in Coconut source)
                        if _coconut_match_check_1:  #88 (line in Coconut source)
                            if _coconut_match_set_name_x is not _coconut_sentinel:  #88 (line in Coconut source)
                                x = _coconut_match_set_name_x  #88 (line in Coconut source)
        ...
        return _coconut_tail_call(func, x)  #88 (line in Coconut source)
...
if TYPE_CHECKING:  #108 (line in Coconut source)
    ...
    def either(*_coconut_match_args, **_coconut_match_kwargs):  #112 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) == 3) and ("left_func" not in _coconut_match_kwargs):  #112 (line in Coconut source)
            _coconut_match_temp_7 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("left_func")  #112 (line in Coconut source)
            _coconut_match_temp_8 = _coconut.getattr(Left, "_coconut_is_data", False) or _coconut.isinstance(Left, _coconut.tuple) and _coconut.all(_coconut.getattr(_coconut_x, "_coconut_is_data", False) for _coconut_x in Left)  # type: ignore  #112 (line in Coconut source)
            _coconut_match_set_name_left_func = _coconut_match_temp_7  #112 (line in Coconut source)
        ...
        if _coconut_match_check_2:  #112 (line in Coconut source)
            ...
            if not _coconut_match_check_2:  #112 (line in Coconut source)
                ...
                if (_coconut_match_temp_8) and (_coconut.isinstance(_coconut_match_args[2], Left)) and (_coconut.len(_coconut_match_args[2]) == 1):  #112 (line in Coconut source)
            ...
            if not _coconut_match_check_2:  #112 (line in Coconut source)
                if (not _coconut_match_temp_8) and (_coconut.isinstance(_coconut_match_args[2], Left)):  #112 (line in Coconut source)
                    _coconut_match_check_2 = True  #112 (line in Coconut source)
                if _coconut_match_check_2:  #112 (line in Coconut source)
                    _coconut_match_check_2 = False  #112 (line in Coconut source)
                    if not _coconut_match_check_2:  #112 (line in Coconut source)
                    ...
                    if not _coconut_match_check_2:  #112 (line in Coconut source)
                        ...
                        if not _coconut.type(_coconut_match_args[2]) in _coconut_self_match_types:  #112 (line in Coconut source)
                            _coconut_match_temp_9 = _coconut.getattr(Left, '__match_args__', ())  #112 (line in Coconut source)
                            if not _coconut.isinstance(_coconut_match_temp_9, _coconut.tuple):  #112 (line in Coconut source)
                                raise _coconut.TypeError("Left.__match_args__ must be a tuple")  #112 (line in Coconut source)
                            if _coconut.len(_coconut_match_temp_9) < 1:  #112 (line in Coconut source)
                                raise _coconut.TypeError("too many positional args in class match (pattern requires 1; 'Left' only supports %s)" % (_coconut.len(_coconut_match_temp_9),))  #112 (line in Coconut source)
                            _coconut_match_temp_10 = _coconut.getattr(_coconut_match_args[2], _coconut_match_temp_9[0], _coconut_sentinel)  #112 (line in Coconut source)
                            if _coconut_match_temp_10 is not _coconut_sentinel:  #112 (line in Coconut source)
                                _coconut_match_set_name_x = _coconut_match_temp_10  #112 (line in Coconut source)
                                _coconut_match_check_2 = True  #112 (line in Coconut source)
                        if _coconut_match_check_2:  #112 (line in Coconut source)
                            if _coconut_match_set_name_x is not _coconut_sentinel:  #112 (line in Coconut source)
                                x = _coconut_match_set_name_x  #112 (line in Coconut source)
        ...
        return _coconut_tail_call(left_func, x)  #112 (line in Coconut source)

    @_coconut_addpattern(either)  #113 (line in Coconut source)
    @_coconut_tco  #113 (line in Coconut source)
    @_coconut_mark_as_match  #113 (line in Coconut source)
    def either(*_coconut_match_args, **_coconut_match_kwargs):  #113 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) == 3) and ("right_func" not in _coconut_match_kwargs):  #113 (line in Coconut source)
            _coconut_match_temp_11 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("right_func")  #113 (line in Coconut source)
            _coconut_match_temp_12 = _coconut.getattr(Right, "_coconut_is_data", False) or _coconut.isinstance(Right, _coconut.tuple) and _coconut.all(_coconut.getattr(_coconut_x, "_coconut_is_data", False) for _coconut_x in Right)  # type: ignore  #113 (line in Coconut source)
            _coconut_match_set_name_right_func = _coconut_match_temp_11  #113 (line in Coconut source)
        ...
        if _coconut_match_check_3:  #113 (line in Coconut source)
            ...
            if not _coconut_match_check_3:  #113 (line in Coconut source)
                ...
                if (_coconut_match_temp_12) and (_coconut.isinstance(_coconut_match_args[2], Right)) and (_coconut.len(_coconut_match_args[2]) == 1):  #113 (line in Coconut source)
            ...
            if not _coconut_match_check_3:  #113 (line in Coconut source)
                if (not _coconut_match_temp_12) and (_coconut.isinstance(_coconut_match_args[2], Right)):  #113 (line in Coconut source)
                    _coconut_match_check_3 = True  #113 (line in Coconut source)
                if _coconut_match_check_3:  #113 (line in Coconut source)
                    _coconut_match_check_3 = False  #113 (line in Coconut source)
                    if not _coconut_match_check_3:  #113 (line in Coconut source)
                    ...
                    if not _coconut_match_check_3:  #113 (line in Coconut source)
                        ...
                        if not _coconut.type(_coconut_match_args[2]) in _coconut_self_match_types:  #113 (line in Coconut source)
                            _coconut_match_temp_13 = _coconut.getattr(Right, '__match_args__', ())  #113 (line in Coconut source)
                            if not _coconut.isinstance(_coconut_match_temp_13, _coconut.tuple):  #113 (line in Coconut source)
                                raise _coconut.TypeError("Right.__match_args__ must be a tuple")  #113 (line in Coconut source)
                            if _coconut.len(_coconut_match_temp_13) < 1:  #113 (line in Coconut source)
                                raise _coconut.TypeError("too many positional args in class match (pattern requires 1; 'Right' only supports %s)" % (_coconut.len(_coconut_match_temp_13),))  #113 (line in Coconut source)
                            _coconut_match_temp_14 = _coconut.getattr(_coconut_match_args[2], _coconut_match_temp_13[0], _coconut_sentinel)  #113 (line in Coconut source)
                            if _coconut_match_temp_14 is not _coconut_sentinel:  #113 (line in Coconut source)
                                _coconut_match_set_name_x = _coconut_match_temp_14  #113 (line in Coconut source)
                                _coconut_match_check_3 = True  #113 (line in Coconut source)
                        if _coconut_match_check_3:  #113 (line in Coconut source)
                            if _coconut_match_set_name_x is not _coconut_sentinel:  #113 (line in Coconut source)
                                x = _coconut_match_set_name_x  #113 (line in Coconut source)
        ...
        return _coconut_tail_call(right_func, x)  #113 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #135 (line in Coconut source)
    __annotations__ = {}  #135 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #145 (line in Coconut source)
    __annotations__ = {}  #145 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #148 (line in Coconut source)
    __annotations__ = {}  #148 (line in Coconut source)
...
if TYPE_CHECKING:  #174 (line in Coconut source)
    ...
    def compare(*_coconut_match_args, **_coconut_match_kwargs):  #178 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "x" in _coconut_match_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 1, "y" in _coconut_match_kwargs)) == 1):  #178 (line in Coconut source)
            _coconut_match_temp_15 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("x")  #178 (line in Coconut source)
            _coconut_match_temp_16 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("y")  #178 (line in Coconut source)
            _coconut_match_set_name_x = _coconut_match_temp_15  #178 (line in Coconut source)
            _coconut_match_set_name_y = _coconut_match_temp_16  #178 (line in Coconut source)
    ...
    def compare(*_coconut_match_args, **_coconut_match_kwargs):  #179 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "x" in _coconut_match_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 1, "y" in _coconut_match_kwargs)) == 1):  #179 (line in Coconut source)
            _coconut_match_temp_17 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("x")  #179 (line in Coconut source)
            _coconut_match_temp_18 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("y")  #179 (line in Coconut source)
            _coconut_match_set_name_x = _coconut_match_temp_17  #179 (line in Coconut source)
            _coconut_match_set_name_y = _coconut_match_temp_18  #179 (line in Coconut source)
    ...
    @_coconut_addpattern(compare)  #180 (line in Coconut source)
    @_coconut_mark_as_match  #180 (line in Coconut source)
    def compare(*_coconut_match_args, **_coconut_match_kwargs):  #180 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "x" in _coconut_match_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 1, "y" in _coconut_match_kwargs)) == 1):  #180 (line in Coconut source)
            _coconut_match_temp_19 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("x")  #180 (line in Coconut source)
            _coconut_match_temp_20 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("y")  #180 (line in Coconut source)
            _coconut_match_set_name_x = _coconut_match_temp_19  #180 (line in Coconut source)
            _coconut_match_set_name_y = _coconut_match_temp_20  #180 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #182 (line in Coconut source)
    __annotations__ = {}  #182 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #185 (line in Coconut source)
    __annotations__ = {}  #185 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #192 (line in Coconut source)
    __annotations__ = {}  #192 (line in Coconut source)
__annotations__["succ"] = '_coconut.typing.Callable[[TEnum], TEnum]'  #192 (line in Coconut source)
succ = (_coconut.functools.partial(_coconut.operator.add, 1))  #193 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #195 (line in Coconut source)
    __annotations__ = {}  #195 (line in Coconut source)
__annotations__["pred"] = '_coconut.typing.Callable[[TEnum], TEnum]'  #195 (line in Coconut source)
pred = (_coconut_partial(_coconut_minus, {1: 1}, 2, ()))  #196 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #200 (line in Coconut source)
    __annotations__ = {}  #200 (line in Coconut source)
...
def enumFromThen(first: 'TEnum', second: 'TEnum') -> '_coconut.typing.Iterable[TEnum]':  #206 (line in Coconut source)
    ...
    return (iterate((_coconut_partial(_coconut.operator.add, {1: step}, 2, ())), first) if step >= 0 else ())  # type: ignore  #208 (line in Coconut source)
...
def enumFromThenTo(first: 'TEnum', second: 'TEnum', last: 'TEnum') -> '_coconut.typing.Iterable[TEnum]':  #214 (line in Coconut source)
    ...
    counter = iterate((_coconut_partial(_coconut.operator.add, {1: step}, 2, ())), first)  #220 (line in Coconut source)
...
def over(x, y):  #281 (line in Coconut source)
    ...
    return _coconut_tail_call(Rational, x, y)  #287 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #300 (line in Coconut source)
    __annotations__ = {}  #300 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #303 (line in Coconut source)
    __annotations__ = {}  #303 (line in Coconut source)
...
if TYPE_CHECKING:  #306 (line in Coconut source)
    ...
    def signum(*_coconut_match_args, **_coconut_match_kwargs):  #311 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "x" in _coconut_match_kwargs)) == 1):  #311 (line in Coconut source)
            _coconut_match_temp_21 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("x")  #311 (line in Coconut source)
            _coconut_match_set_name_x = _coconut_match_temp_21  #311 (line in Coconut source)
    ...
    @_coconut_addpattern(signum)  #312 (line in Coconut source)
    @_coconut_mark_as_match  #312 (line in Coconut source)
    def signum(*_coconut_match_args, **_coconut_match_kwargs):  #312 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "x" in _coconut_match_kwargs)) == 1):  #312 (line in Coconut source)
            _coconut_match_temp_22 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("x")  #312 (line in Coconut source)
            _coconut_match_set_name_x = _coconut_match_temp_22  #312 (line in Coconut source)
...
if TYPE_CHECKING:  #319 (line in Coconut source)
    ...
    def toRational(*_coconut_match_args, **_coconut_match_kwargs):  #323 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "real" in _coconut_match_kwargs)) == 1):  #323 (line in Coconut source)
            _coconut_match_temp_23 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("real")  #323 (line in Coconut source)
            if (isinstance)(_coconut_match_temp_23, float):  #323 (line in Coconut source)
                _coconut_match_set_name_real = _coconut_match_temp_23  #323 (line in Coconut source)
    ...
    @_coconut_addpattern(toRational)  #325 (line in Coconut source)
    @_coconut_tco  #325 (line in Coconut source)
    @_coconut_mark_as_match  #325 (line in Coconut source)
    def toRational(*_coconut_match_args, **_coconut_match_kwargs):  #325 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "real" in _coconut_match_kwargs)) == 1):  #325 (line in Coconut source)
            _coconut_match_temp_24 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("real")  #325 (line in Coconut source)
            _coconut_match_set_name_real = _coconut_match_temp_24  #325 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #339 (line in Coconut source)
    __annotations__ = {}  #339 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #342 (line in Coconut source)
    __annotations__ = {}  #342 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #352 (line in Coconut source)
    __annotations__ = {}  #352 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #358 (line in Coconut source)
    __annotations__ = {}  #358 (line in Coconut source)
__annotations__["recip"] = '_coconut.typing.Callable[[Fractional], Fractional]'  #358 (line in Coconut source)
recip = (_coconut.functools.partial(_coconut.operator.truediv, 1))  #359 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #395 (line in Coconut source)
    __annotations__ = {}  #395 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #398 (line in Coconut source)
    __annotations__ = {}  #398 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #401 (line in Coconut source)
    __annotations__ = {}  #401 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #404 (line in Coconut source)
    __annotations__ = {}  #404 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #451 (line in Coconut source)
    __annotations__ = {}  #451 (line in Coconut source)
...
if TYPE_CHECKING:  #454 (line in Coconut source)
    ...
    @_coconut_addpattern(lcm)  #460 (line in Coconut source)
    @_coconut_mark_as_match  #460 (line in Coconut source)
    def lcm(*_coconut_match_args, **_coconut_match_kwargs):  #460 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "x" in _coconut_match_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 1, "y" in _coconut_match_kwargs)) == 1):  #460 (line in Coconut source)
            _coconut_match_temp_25 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("x")  #460 (line in Coconut source)
            _coconut_match_temp_26 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("y")  #460 (line in Coconut source)
            _coconut_match_set_name_x = _coconut_match_temp_25  #460 (line in Coconut source)
            _coconut_match_set_name_y = _coconut_match_temp_26  #460 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #463 (line in Coconut source)
    __annotations__ = {}  #463 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #466 (line in Coconut source)
    __annotations__ = {}  #466 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #485 (line in Coconut source)
    __annotations__ = {}  #485 (line in Coconut source)
...
def liftA2(func: '_coconut.typing.Callable[[Ta, Tb], Tc]') -> '_coconut.typing.Callable[[Applicative[Ta], Applicative[Tb]], Applicative[Tc]]':  #616 (line in Coconut source)
    ...
    return (lambda f1, f2: (ap)(fmap(_coconut.functools.partial(_coconut.functools.partial, func), f1), f2))  # type: ignore  #621 (line in Coconut source)
...
if TYPE_CHECKING:  #719 (line in Coconut source)
    ...
    def do(*_coconut_match_args, **_coconut_match_kwargs):  #723 (line in Coconut source)
        ...
        if (1 <= _coconut.len(_coconut_match_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_args) > 1, "func" in _coconut_match_kwargs)) == 1):  #723 (line in Coconut source)
            if (_coconut.isinstance(_coconut_match_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_args[0]) == 0):  #723 (line in Coconut source)
                _coconut_match_temp_27 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("func")  #723 (line in Coconut source)
                _coconut_match_set_name_func = _coconut_match_temp_27  #723 (line in Coconut source)
    ...
    @_coconut_addpattern(do)  #724 (line in Coconut source)
    @_coconut_tco  #724 (line in Coconut source)
    @_coconut_mark_as_match  #724 (line in Coconut source)
    def do(*_coconut_match_args, **_coconut_match_kwargs):  #724 (line in Coconut source)
        """
        The call
            do([m1, m2, ...], func)
        ...
        if (1 <= _coconut.len(_coconut_match_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_args) > 1, "func" in _coconut_match_kwargs)) == 1):  #744 (line in Coconut source)
            if (_coconut.isinstance(_coconut_match_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_args[0]) >= 1):  #744 (line in Coconut source)
                ...
                _coconut_match_temp_29 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("func")  #744 (line in Coconut source)
                _coconut_match_temp_28 = _coconut.list(_coconut_match_args[0][1:])  #744 (line in Coconut source)
                _coconut_match_set_name_func = _coconut_match_temp_29  #744 (line in Coconut source)
                _coconut_match_set_name_ms = _coconut_match_temp_28  #744 (line in Coconut source)
        ...
        return _coconut_tail_call((bind), m, lambda x: do(ms, _coconut.functools.partial(func, x)))  #744 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #756 (line in Coconut source)
    __annotations__ = {}  #756 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #768 (line in Coconut source)
    __annotations__ = {}  #768 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #777 (line in Coconut source)
    __annotations__ = {}  #777 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #783 (line in Coconut source)
    __annotations__ = {}  #783 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #786 (line in Coconut source)
    __annotations__ = {}  #786 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #789 (line in Coconut source)
    __annotations__ = {}  #789 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #792 (line in Coconut source)
    __annotations__ = {}  #792 (line in Coconut source)
__annotations__["product"] = '_coconut.typing.Callable[[Foldable[TNum]], TNum]'  #792 (line in Coconut source)
product = _coconut.functools.partial(reduce, _coconut.operator.mul)  #793 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #804 (line in Coconut source)
    __annotations__ = {}  #804 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #807 (line in Coconut source)
    __annotations__ = {}  #807 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #810 (line in Coconut source)
    __annotations__ = {}  #810 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #816 (line in Coconut source)
    __annotations__ = {}  #816 (line in Coconut source)
...
def until(cond: '_coconut.typing.Callable[[Ta], bool]', func: '_coconut.typing.Callable[[Ta], Ta]', x: 'Ta') -> 'Ta':  #851 (line in Coconut source)
    while True:  #852 (line in Coconut source)
        ...
        try:  # tail recursive  #854 (line in Coconut source)
            _coconut_tre_check_0 = until is _coconut_recursive_func_65  # tail recursive  #854 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #883 (line in Coconut source)
    __annotations__ = {}  #883 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  # type: ignore  #910 (line in Coconut source)
    __annotations__ = {}  # type: ignore  #910 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  # type: ignore  #921 (line in Coconut source)
    __annotations__ = {}  # type: ignore  #921 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #924 (line in Coconut source)
    __annotations__ = {}  #924 (line in Coconut source)
__annotations__["head"] = '_coconut.typing.Callable[[_coconut.typing.Iterable[Ta]], Ta]'  #924 (line in Coconut source)
head = _coconut.functools.partial(_coconut_iter_getitem, index=(0))  #925 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #927 (line in Coconut source)
    __annotations__ = {}  #927 (line in Coconut source)
__annotations__["last"] = '_coconut.typing.Callable[[_coconut.typing.Iterable[Ta]], Ta]'  #927 (line in Coconut source)
last = _coconut.functools.partial(_coconut_iter_getitem, index=(-1))  #928 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #930 (line in Coconut source)
    __annotations__ = {}  #930 (line in Coconut source)
...
tail = _coconut.functools.partial(_coconut_iter_getitem, index=(_coconut.slice(1, None)))  # type: ignore  #931 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #933 (line in Coconut source)
    __annotations__ = {}  #933 (line in Coconut source)
...
init = _coconut.functools.partial(_coconut_iter_getitem, index=(_coconut.slice(None, -1)))  # type: ignore  #934 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #944 (line in Coconut source)
    __annotations__ = {}  #944 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #950 (line in Coconut source)
    __annotations__ = {}  #950 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #953 (line in Coconut source)
    __annotations__ = {}  #953 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #956 (line in Coconut source)
    __annotations__ = {}  #956 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #959 (line in Coconut source)
    __annotations__ = {}  #959 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #965 (line in Coconut source)
    __annotations__ = {}  #965 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #976 (line in Coconut source)
    __annotations__ = {}  #976 (line in Coconut source)
...
@recursive_iterator  #986 (line in Coconut source)
...
@recursive_iterator  #990 (line in Coconut source)
...
if TYPE_CHECKING:  #997 (line in Coconut source)
    ...
    @recursive_iterator  #1001 (line in Coconut source)
    @_coconut_tco  #1002 (line in Coconut source)
    @_coconut_mark_as_match  #1002 (line in Coconut source)
    def cycle(*_coconut_match_args, **_coconut_match_kwargs):  #1002 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "xs" in _coconut_match_kwargs)) == 1):  #1002 (line in Coconut source)
            _coconut_match_temp_30 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("xs")  #1002 (line in Coconut source)
            _coconut_match_set_name_xs = _coconut_match_temp_30  #1002 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1018 (line in Coconut source)
    __annotations__ = {}  #1018 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1021 (line in Coconut source)
    __annotations__ = {}  #1021 (line in Coconut source)
...
if TYPE_CHECKING:  #1024 (line in Coconut source)
    ...
    @_coconut_addpattern(span)  #1029 (line in Coconut source)
    @_coconut_mark_as_match  #1029 (line in Coconut source)
    def span(*_coconut_match_args, **_coconut_match_kwargs):  #1029 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) == 2) and ("cond" not in _coconut_match_kwargs):  #1029 (line in Coconut source)
            if (_coconut.isinstance(_coconut_match_args[1], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_args[1]) >= 1):  #1029 (line in Coconut source)
                _coconut_match_temp_31 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("cond")  #1029 (line in Coconut source)
                _coconut_match_set_name_x = _coconut_match_args[1][0]  #1029 (line in Coconut source)
                _coconut_match_set_name_cond = _coconut_match_temp_31  #1029 (line in Coconut source)
                _coconut_match_temp_32 = _coconut.list(_coconut_match_args[1][1:])  #1029 (line in Coconut source)
                _coconut_match_set_name_xs = _coconut_match_temp_32  #1029 (line in Coconut source)
    ...
    @_coconut_addpattern(span)  #1032 (line in Coconut source)
    @_coconut_mark_as_match  #1032 (line in Coconut source)
    def span(*_coconut_match_args, **_coconut_match_kwargs):  #1032 (line in Coconut source)
        ...
        if (_coconut.len(_coconut_match_args) <= 2) and (_coconut.sum((_coconut.len(_coconut_match_args) > 0, "cond" in _coconut_match_kwargs)) == 1) and (_coconut.sum((_coconut.len(_coconut_match_args) > 1, "xs" in _coconut_match_kwargs)) == 1):  #1032 (line in Coconut source)
            _coconut_match_temp_33 = _coconut_match_args[0] if _coconut.len(_coconut_match_args) > 0 else _coconut_match_kwargs.pop("cond")  #1032 (line in Coconut source)
            _coconut_match_temp_34 = _coconut_match_args[1] if _coconut.len(_coconut_match_args) > 1 else _coconut_match_kwargs.pop("xs")  #1032 (line in Coconut source)
            _coconut_match_set_name_cond = _coconut_match_temp_33  #1032 (line in Coconut source)
            _coconut_match_set_name_xs = _coconut_match_temp_34  #1032 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  # type: ignore  #1062 (line in Coconut source)
    __annotations__ = {}  # type: ignore  #1062 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1065 (line in Coconut source)
    __annotations__ = {}  #1065 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1077 (line in Coconut source)
    __annotations__ = {}  #1077 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1083 (line in Coconut source)
    __annotations__ = {}  #1083 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1086 (line in Coconut source)
    __annotations__ = {}  #1086 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1092 (line in Coconut source)
    __annotations__ = {}  #1092 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1107 (line in Coconut source)
    __annotations__ = {}  #1107 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1119 (line in Coconut source)
    __annotations__ = {}  #1119 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1185 (line in Coconut source)
    __annotations__ = {}  #1185 (line in Coconut source)
...
def putStr(s: 'str') -> 'IO':  #1218 (line in Coconut source)
    return _coconut_tail_call(IO, _coconut.functools.partial(_print, s, end=""))  #1219 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1221 (line in Coconut source)
    __annotations__ = {}  #1221 (line in Coconut source)
...
def putStrLn(s: 'str') -> 'IO':  #1224 (line in Coconut source)
    return _coconut_tail_call(IO, _coconut.functools.partial(_print, s))  #1225 (line in Coconut source)

# type: ignore
@_coconut_tco  # type: ignore  #1227 (line in Coconut source)
def print(x: 'Ta') -> 'IO':  # type: ignore  #1227 (line in Coconut source)
    return _coconut_tail_call(IO, _coconut.functools.partial(_print, show(x)))  #1228 (line in Coconut source)


### Input functions:

getChar = IO(_coconut.functools.partial(sys.stdin.read, 1))  # type: IO  #1232 (line in Coconut source)
if "__annotations__" not in _coconut.locals():  #1232 (line in Coconut source)
    __annotations__ = {}  #1232 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1234 (line in Coconut source)
    __annotations__ = {}  #1234 (line in Coconut source)
...
if "__annotations__" not in _coconut.locals():  #1236 (line in Coconut source)
    __annotations__ = {}  #1236 (line in Coconut source)
...
def readIO(s: 'str') -> 'IO':  #1266 (line in Coconut source)
    return _coconut_tail_call(IO, _coconut.functools.partial(read, s))  #1267 (line in Coconut source)
