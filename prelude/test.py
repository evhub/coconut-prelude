...
def test_Tuples():  #44 (line in coconut source)
    ...
    def _coconut_lambda_0(*_coconut_match_to_args, **_coconut_match_to_kwargs):  #46 (line in coconut source)
        _coconut_match_check = False  #46 (line in coconut source)
        _coconut_FunctionMatchError = _coconut_get_function_match_error()  #46 (line in coconut source)
        if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut.isinstance(_coconut_match_to_args[0], _coconut.abc.Sequence)) and (_coconut.len(_coconut_match_to_args[0]) == 2):  #46 (line in coconut source)
            x = _coconut_match_to_args[0][0]  #46 (line in coconut source)
            y = _coconut_match_to_args[0][1]  #46 (line in coconut source)
            if not _coconut_match_to_kwargs:  #46 (line in coconut source)
                _coconut_match_check = True  #46 (line in coconut source)
        if not _coconut_match_check:  #46 (line in coconut source)
            raise _coconut_FunctionMatchError('assert curry_tuple(+)((1, 2),) == 3 == uncurry_tuple(def ((x, y),) -> x + y)(1, 2)', _coconut_match_to_args)  #46 (line in coconut source)
