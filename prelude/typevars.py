...
if _coconut.typing.TYPE_CHECKING:  #2 (line in Coconut source)
    ...
    try:  #2 (line in Coconut source)
        T = _coconut.typing  #2 (line in Coconut source)
...
Tco = T.TypeVar("Tco", covariant=True)  #10 (line in Coconut source)
Tcontra = T.TypeVar("Tcontra", contravariant=True)  #11 (line in Coconut source)

TType = T.TypeVar("TType", bound=T.Type)  #13 (line in Coconut source)
